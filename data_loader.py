...
class DataLoader:
    DATA_PATH = "C:/Users/Gangadi rajy reddy/Documents/MUStARD/data/sarcasm_data.json"
    AUDIO_PICKLE = "C:/Users/Gangadi rajy reddy/Documents/MUStARD/data/audio_features.p"
    INDICES_FILE = "C:/Users/Gangadi rajy reddy/Documents/MUStARD/data/split_indices.p"
    GLOVE_DICT = "C:/Users/Gangadi rajy reddy/Documents/MUStARD/data/glove_full_dict.p"
    BERT_TARGET_EMBEDDINGS = "C:/Users/Gangadi rajy reddy/Documents/MUStARD/BERT_text_features/bert-output.jsonl"
    BERT_CONTEXT_EMBEDDINGS = "C:/Users/Gangadi rajy reddy/Documents/MUStARD/BERT_text_features/bert-output-context.jsonl"
    UTT_ID = 0
    CONTEXT_ID = 2
    SHOW_ID = 9
    UNK_TOKEN = "<UNK>"
    ...
    def __init__(self, config: config.Config) -> None:
        ...
        if config.use_target_video:
            video_features_file = h5py.File("C:/Users/Gangadi rajy reddy/Documents/MUStARD/data/features/utterances_final/resnet_pool5.hdf5","r")
            context_video_features_file = h5py.File("C:/Users/Gangadi rajy reddy/Documents/MUStARD/data/features/context_final/resnet_pool5.hdf5","r")
        else:
    ...
    def setup_glove_dict(self) -> None:
        ...
        if os.path.exists(self.GLOVE_DICT):
        	...
        	self.word_emb_dict = {}
        	with open(self.config.word_embedding_path , encoding = "utf-8") as file:
         		for line in file:
...
class DataHelper:
    ...
    GLOVE_MODELS = "C:/Users/Gangadi rajy reddy/Documents/MUStARD/data/temp/glove_dict_{}.p"
    GLOVE_MODELS_CONTEXT = "C:/Users/Gangadi rajy reddy/Documents/MUStARD/data/temp/glove_dict_context_{}.p"
